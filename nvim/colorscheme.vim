...
function! g:BuffetSetCustomColors()
    hi! BuffetCurrentBuffer          cterm=NONE      ctermbg=1 ctermfg=8 guibg=#d8dee9 guifg=#2e3440
	hi! BuffetActiveBuffer           cterm=NONE      ctermbg=1 ctermfg=8 guibg=#d8dee9 guifg=#2e3440
